        ...
        <div className='bg-white px-6 py-12  2xl:p-12 rounded-md relative '>
          ...
          <div>
            ...
            <div className="text-center">
              ...
              <p className="text-md font-medium mt-4">Your Coupon code is </p>
              <div className="border-2 border-dashed border-[#845cc7] rounded-lg py-4 my-2">
                ...
                <h3 className="text-5xl font-bold">$10 <small className="text-2xl"><del> $20</del></small></h3>
            </div>

          </div>
          <div>
            <Link href="/courses?coupon=NY2023" onClick={() => onClose()}>
              <button className="uppercase text-white font-semibold py-2 rounded-lg text-lg px-8 mt-8 w-full  bg-gradient-to-r from-[#0070F4] to-[#8253db]">
                buy now
              </button>
            </Link>
          </div>
