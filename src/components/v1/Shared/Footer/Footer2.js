    ...
    <>
      <footer aria-labelledby="footer-heading" className=" border-t border-slate-200 bg-[#030A21]">
        ...
        <div className="mx-auto max-w-7xl pt-12 pb-8 px-4 sm:px-6 lg:px-8 lg:pt-24 ">
              ...
              <div className="sm:grid-cols-2 md:col-span-2 md:grid md:gap-8">
                ...
                <div className="mt-12 md:mt-0">
                  <div className="flex flex-col gap-y-4">
                    ...
                    <ul className="flex flex-col gap-y-3" role="list">
                      <li><span className="font-normal text-sm"><Link className="transition-colors text-[#A3A9B9] hover:text-blue-600" href="/#">Pricing</Link></span>
                      </li>
                      <li><span className="font-normal text-sm"><Link className="transition-colors text-[#A3A9B9] hover:text-blue-600" href="/#">About</Link></span>
                      </li>
                      <li><span className="font-normal text-sm"><Link className="transition-colors text-[#A3A9B9] hover:text-blue-600" href="/#">Contact Us</Link></span>
                      </li>
                      <li><span className="font-normal text-sm"><Link className="transition-colors text-[#A3A9B9] hover:text-blue-600" href="/#">Become an Affiliate</Link></span>
                      </li>
                    </ul>
                  </div>
          ...
          <div className="mt-12 border-t border-slate-200 pt-8"><p className="text-base text-[#94A3B8] xl:text-center">© {getFullYear} Xplainerr, All rights reserved.
          </p>
          </div>
        </div>
      </footer>
