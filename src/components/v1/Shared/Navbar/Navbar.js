          ...
          <nav className={`relative text-sm  ${styles.navbar__container}`}>
            ...
            {workShopsOpen && (
              <div
                ...
                className="absolute left-[120px] top-14 z-10 mt-2 bg-white pb-2 shadow-xl big:left-32"
              >
          ...
          <div className={`px-3 ${styles.navbar__sign}`}>
            {currentUser?.email ? (
              ...
              <div className="space-x-5">
                ...
                <button className=" my-1 rounded-[10px] border-2 border-[#AED3FF] bg-[#0070F4] py-2 px-[15px] text-white">
                  Sign Up
                </button>
              </div>
            )}
