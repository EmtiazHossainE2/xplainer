      ...
      <div className="container mx-auto py-20 px-5 lg:px-12 big:px-36 large:px-96">
        <div className="">
          ...
          <div className="max-w-3xl mx-auto text-center pb-10 ">
            <h1 className="text-[32px] font-bold leading-tight ">Instructors & Mentors  </h1>
          </div>
        </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-5'>
          {authors.map((author, index) => (
            <div key={index} className="flex justify-center gap-3 bg-[#EAECF0] p-5 rounded-lg h-[172px]">
              <div>
              ...
              <div>
                ...
                <p className='text-[#9CA3AF] text-sm pt-1 pb-4'>{author.job}</p>
                <p className='text-[#6B7280] font-medium'>{author.description}</p>
              </div>
            </div>
          ))}
        </div>
