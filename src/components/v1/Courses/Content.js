...
const Content = ({ content, index, onTitleClick, isOpen = true }) => {
  ...
  return (
    <div key={index} className="mb-3 rounded-md px-2 pt-2">
      {/* *************************** Module *************************** */}
      <div
        className="text-l flex cursor-pointer items-center justify-between rounded-md border border-[#E5E7EB] bg-[#E5E7EB] py-2.5 pl-6 pr-3 font-semibold text-[#333333] md:text-2xl"
