...
const Offer = () => {
  ...
  return (
    <div className="bg-[#FAFBFF]">
      <div className="container mx-auto pt-[140px] pb-16 px-5 lg:px-12 big:px-36 large:px-96">
        <div className='flex justify-between gap-16'>
          {/******************** Left  ********************/}
          <div className='basis-1/2  w-[465px] h-[500px] bg-[#000] border shadow-[8px_8px_0px_-2px_#000000] rounded-2xl p-11'>
