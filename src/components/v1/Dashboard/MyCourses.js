      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 lg:mb-56 2xl:mb-72">
        {/* {myCourses &&
          myCourses.map((course, index) => (
            <div key={index} className=" border border-[#EAECF0] rounded-[9px]">
              <div>
              ...
              <div className="px-3.5">
                ...
                <Link href='/dashboard' className=" bg-[#ECF5FF] border border-[#0070F4] rounded-[4px] w-full flex justify-center h-[33px] mt-8">
