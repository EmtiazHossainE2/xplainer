    ...
    <div className='container mx-auto py-4 px-5 lg:px-20'>
      <div className='flex flex-col lg:flex-row justify-between mt-12 items-center gap-5'>
        ...
        <div className='basis-1/2 text-center lg:text-start'>
          <h2 className="text-2xl md:text-3xl lg:text-6xl 2xl:text-6xl font-bold pb-5 md:py-5">Accelerate your <br /> tech career</h2>
          <p className='text-gray-500 text-[24px] '>We provide niche up skilling courses to help your accelerate and succeed in tech career</p>
          <div className="pt-12">
