...
* PMs don’t build revolutionary brand new products from scratch every day and if this excites you, trust me, be an entrepreneur. I have observed that most startups achieve product-market fit *(i.e. their product is somewhat stable & a lot of people are using the product)* when they hire their first PM. Founders are the first product manager of a startup. As a PM, most of the time you will be working on
    
    **incremental improvement** of a small feature, a set of feature or building a new feature from scratch.
